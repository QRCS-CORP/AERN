...
AERN\+\_\+\+EXPORT\+\_\+\+API void \mbox{\hyperlink{certificate_8h_a17ed72de8cf1eef68bd6f2ee027b42e3}{aern\+\_\+certificate\+\_\+child\+\_\+revoke}} (\mbox{\hyperlink{structaern__child__certificate}{aern\+\_\+child\+\_\+certificate}} \texorpdfstring{$\ast$}{*}child)
\begin{DoxyCompactList}\small\item\em Revoke a child certificate. \end{DoxyCompactList}\item 
...
AERN\+\_\+\+EXPORT\+\_\+\+API bool \mbox{\hyperlink{certificate_8h_a4460c848d4167ba21ef6d2e27194c437}{aern\+\_\+certificate\+\_\+signature\+\_\+generate\+\_\+keypair}} (\mbox{\hyperlink{structaern__signature__keypair}{aern\+\_\+signature\+\_\+keypair}} \texorpdfstring{$\ast$}{*}keypair)
...
{\em name} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The protocol-\/set string (for example, "{}dilithium-\/s1\+\_\+kyber-\/s1\+\_\+rcs-\/256\+\_\+sha3-\/256"{}).\\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em conf} & \mbox{[}\doxylink{aern_8h_a6249420c8c2d55814707fff2f6caaef9}{aern\+\_\+configuration\+\_\+sets}\mbox{]} The protocol-\/set enumerator to test.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em name} & \mbox{[}char\texorpdfstring{$\ast$}{*}\mbox{]} The output buffer that will receive the protocol-\/set string. \\
\hline
{\em conf} & \mbox{[}\doxylink{aern_8h_a6249420c8c2d55814707fff2f6caaef9}{aern\+\_\+configuration\+\_\+sets}\mbox{]} The protocol-\/set enumerator to encode. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em a} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The first certificate. \\
\hline
{\em b} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The second certificate.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em output} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The destination child certificate. \\
\hline
{\em input} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The source child certificate. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the empty child certificate to populate. \\
\hline
{\em pubkey} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the public signature key. \\
\hline
{\em expiration} & \mbox{[}const aern\+\_\+certificate\+\_\+expiration\texorpdfstring{$\ast$}{*}\mbox{]} The certificate expiration time structure. \\
\hline
{\em issuer} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The certificate issuer string. \\
\hline
{\em designation} & \mbox{[}\doxylink{aern_8h_ac7ca2a3bb609d399444bb84336afa62a}{aern\+\_\+network\+\_\+designations}\mbox{]} The certificate designation type (e.\+g. aps, client, etc.). \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The pointer to the child certificate structure to populate. \\
\hline
{\em enck} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The encoded certificate string.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The pointer to the child certificate structure to populate. \\
\hline
{\em input} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The input byte array containing the serialized certificate. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em enck} & \mbox{[}char\texorpdfstring{$\ast$}{*}\mbox{]} The output buffer that will receive the encoded certificate string. \\
\hline
{\em child} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The child certificate to encode.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate to erase. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em fpath} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The file path from which to load the certificate. \\
\hline
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate structure.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em output} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The output hash array (size\+: AERN\+\_\+\+CERTIFICATE\+\_\+\+HASH\+\_\+\+SIZE). \\
\hline
{\em child} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em message} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The output buffer for the recovered message (if applicable). \\
\hline
{\em msglen} & \mbox{[}size\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the length of the recovered message. \\
\hline
{\em signature} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the signature. \\
\hline
{\em siglen} & \mbox{[}size\+\_\+t\mbox{]} The length of the signature. \\
\hline
{\em child} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate.\\
\hline
\end{DoxyParams}
...
\end{DoxyReturn}
\Hypertarget{certificate_8h_a17ed72de8cf1eef68bd6f2ee027b42e3}\index{certificate.h@{certificate.h}!aern\_certificate\_child\_revoke@{aern\_certificate\_child\_revoke}}
\index{aern\_certificate\_child\_revoke@{aern\_certificate\_child\_revoke}!certificate.h@{certificate.h}}
\doxysubsubsection{\texorpdfstring{aern\_certificate\_child\_revoke()}{aern\_certificate\_child\_revoke()}}
{\footnotesize\ttfamily \label{certificate_8h_a17ed72de8cf1eef68bd6f2ee027b42e3} 
AERN\+\_\+\+EXPORT\+\_\+\+API void aern\+\_\+certificate\+\_\+child\+\_\+revoke (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structaern__child__certificate}{aern\+\_\+child\+\_\+certificate}} \texorpdfstring{$\ast$}{*}}]{child}{}\end{DoxyParamCaption})}



Revoke a child certificate. 

This function sets the child to revoked status, erases the root serial number, the signed certificate hash, and sets expiration times to zero.


\begin{DoxyParams}{Parameters}
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em output} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the array receiving the serialized certificate (size\+: AERN\+\_\+\+CERTIFICATE\+\_\+\+CHILD\+\_\+\+SIZE). \\
\hline
{\em child} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The child certificate to serialize. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em fpath} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The file path where the certificate will be stored. \\
\hline
{\em child} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate structure.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns true on success. 
...
\begin{DoxyParams}{Parameters}
{\em sdsg} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The network-\/designation string.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em sdsg} & \mbox{[}char\texorpdfstring{$\ast$}{*}\mbox{]} The output buffer that will receive the encoded network-\/designation string. \\
\hline
{\em designation} & \mbox{[}\doxylink{aern_8h_ac7ca2a3bb609d399444bb84336afa62a}{aern\+\_\+network\+\_\+designations}\mbox{]} The certificate designation type.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em expiration} & \mbox{[}aern\+\_\+certificate\+\_\+expiration\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the expiration structure. \\
\hline
{\em start} & \mbox{[}uint16\+\_\+t\mbox{]} The number of days until the certificate becomes valid. \\
\hline
{\em duration} & \mbox{[}uint16\+\_\+t\mbox{]} The number of days the certificate remains valid. \\
\hline
\end{DoxyParams}
...
{\em expiration} & \mbox{[}aern\+\_\+certificate\+\_\+expiration\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the expiration structure. \\
\hline
{\em start} & \mbox{[}uint64\+\_\+t\mbox{]} The number of seconds to delay before the certificate becomes valid. \\
\hline
{\em period} & \mbox{[}uint64\+\_\+t\mbox{]} The number of seconds the certificate remains valid. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em expiration} & \mbox{[}const aern\+\_\+certificate\+\_\+expiration\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the expiration time structure.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em signature} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The array receiving the signature (size\+: AERN\+\_\+\+ASYMMETRIC\+\_\+\+SIGNATURE\+\_\+\+SIZE). \\
\hline
{\em sigkey} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The private signature key. \\
\hline
{\em message} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The message to sign. \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em a} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The first root certificate. \\
\hline
{\em b} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The second root certificate.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em root} & \mbox{[}aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the empty root certificate to populate. \\
\hline
{\em pubkey} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the public signature key. \\
\hline
{\em expiration} & \mbox{[}const aern\+\_\+certificate\+\_\+expiration\texorpdfstring{$\ast$}{*}\mbox{]} The certificate expiration time structure. \\
\hline
{\em issuer} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The issuer name string. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em root} & \mbox{[}aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The pointer to the root certificate structure to populate. \\
\hline
{\em enck} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The encoded certificate string.\\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em root} & \mbox{[}aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root certificate structure to populate. \\
\hline
{\em input} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the input byte array (size\+: AERN\+\_\+\+CERTIFICATE\+\_\+\+ROOT\+\_\+\+SIZE). \\
\hline
\end{DoxyParams}
...
{\em enck} & \mbox{[}char\texorpdfstring{$\ast$}{*}\mbox{]} The output buffer that will receive the encoded certificate string. \\
\hline
{\em root} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The root certificate to encode.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns the size of the encoded certificate string. 
...
\begin{DoxyParams}{Parameters}
{\em root} & \mbox{[}aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root certificate to erase. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em fpath} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The file path from which to read the certificate. \\
\hline
{\em root} & \mbox{[}aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root certificate structure to populate.\\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em output} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The output hash array. \\
\hline
{\em root} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root certificate. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em output} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the array receiving the serialized certificate (size\+: AERN\+\_\+\+CERTIFICATE\+\_\+\+ROOT\+\_\+\+SIZE). \\
\hline
{\em root} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} The root certificate to serialize. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em child} & \mbox{[}aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate to sign. \\
\hline
{\em root} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root certificate. \\
\hline
{\em rsigkey} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root private signing key.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns the size of the generated signature. 
...
\begin{DoxyParams}{Parameters}
{\em fpath} & \mbox{[}const char\texorpdfstring{$\ast$}{*}\mbox{]} The file path where the certificate will be written. \\
\hline
{\em root} & \mbox{[}const aern\+\_\+root\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the root certificate structure.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns true on success. 
\end{DoxyReturn}
\Hypertarget{certificate_8h_a4460c848d4167ba21ef6d2e27194c437}\index{certificate.h@{certificate.h}!aern\_certificate\_signature\_generate\_keypair@{aern\_certificate\_signature\_generate\_keypair}}
...
{\footnotesize\ttfamily \label{certificate_8h_a4460c848d4167ba21ef6d2e27194c437} 
AERN\+\_\+\+EXPORT\+\_\+\+API bool aern\+\_\+certificate\+\_\+signature\+\_\+generate\+\_\+keypair (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structaern__signature__keypair}{aern\+\_\+signature\+\_\+keypair}} \texorpdfstring{$\ast$}{*}}]{keypair}{}\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em keypair} & \mbox{[}aern\+\_\+signature\+\_\+keypair\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the keypair container.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns true if the root certificate is valid. 
...
\begin{DoxyParams}{Parameters}
{\em signature} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the signed hash. \\
\hline
{\em siglen} & \mbox{[}size\+\_\+t\mbox{]} The length of the signed hash. \\
\hline
{\em message} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the message. \\
\hline
{\em msglen} & \mbox{[}size\+\_\+t\mbox{]} The length of the message. \\
\hline
{\em lcert} & \mbox{[}const aern\+\_\+child\+\_\+certificate\texorpdfstring{$\ast$}{*}\mbox{]} A pointer to the child certificate used for verification.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em signature} & \mbox{[}uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The array that will receive the signature (size\+: AERN\+\_\+\+ASYMMETRIC\+\_\+\+SIGNATURE\+\_\+\+SIZE). \\
\hline
{\em message} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The message to sign. \\
\hline
{\em msglen} & \mbox{[}size\+\_\+t\mbox{]} The length of the message. \\
\hline
{\em prikey} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The private signature key.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em message} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The original message. \\
\hline
{\em msglen} & \mbox{[}size\+\_\+t\mbox{]} The length of the message. \\
\hline
{\em signature} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The signature to verify. \\
\hline
{\em siglen} & \mbox{[}size\+\_\+t\mbox{]} The length of the signature. \\
\hline
{\em pubkey} & \mbox{[}const uint8\+\_\+t\texorpdfstring{$\ast$}{*}\mbox{]} The public signature verification key.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
